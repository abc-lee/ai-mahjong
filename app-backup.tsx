  ...
  useEffect(() => {
    ...
    const cleanup = setupSocketListeners({
      ...
      onGameEnd: (winner, winningHand) => {
        ...
        setAvailableActions([]);
        // 设置游戏结束状态
        setGameEnded(winner, winningHand);
      },
      onError: (message) => {
        alert(`错误: ${message}`);
      },
